#!/bin/bash
#SBATCH --job-name=busco_purge_tutorial
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
run_BUSCO.py -i /labs/Wegrzyn/Moss/Physcomitrellopsis_africana/Physcomitrellopsis_africana_Genome/RawData_Nanopore_5074/5074_test_LSK109_30JAN19/purge_haplotigs/physcomitrellopsis_africana_polished_3kb_rmvcontam_assembly.fasta -l /labs/Wegrzyn/Moss/Physcomitrium/viridiplantae_odb10/ -o physcomitrellopsis_africana_purgehaplotigs_busco_tutorial -m geno -c 1
