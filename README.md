...
This is a de novo assembler, this assembler, like MaSuRCA which we will be encountering later, requires a config file to run through the data. The configuration file can be found https://github.com/CBC-UCONN/Genome-Assembly-Bacterial/blob/master/SOAPdenovo%20config%20file
